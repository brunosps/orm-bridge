import { SearchColumnType, SearchOperator } from '@core/sql/types';
import { SearchColumnBase } from './search-column-resolver';

export class SearchColumnResolverMYSQL extends SearchColumnBase {
  getFormatValue() {
    switch (this.operator) {
      ...
      case SearchOperator[SearchOperator.i_like]:
  ...
  i_like(): string {
    return `UPPER(${this.columnName}) LIKE UPPER(:${this.formatName()})`;
  }
